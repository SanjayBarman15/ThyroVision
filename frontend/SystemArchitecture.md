    ...
    Communication: FAST APIs over HTTPS to the backend

    3.2 Responsibilities

    Doctor authentication (via Supabase Auth)

    Patient data entry (name, DOB, gender, notes)
    ...
    Backend responds with prediction, confidence
    ...
    Handle FAST API requests from frontend
    ...
    Backbone: Faster R-CNN + ResNet for detection and Xcepiton for classification
    ...
    Save prediction, confidence score, to Supabase Storage
